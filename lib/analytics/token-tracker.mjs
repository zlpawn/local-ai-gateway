  ...
  return {
    ...
    queryUsage(options = {}) {
      ...
      const purposeStmt = db.prepare(`
        ...
        FROM token_usage_logs
        WHERE ${whereSql}
        GROUP BY purpose, native_currency
      `);
      ...
      const clientStmt = db.prepare(`
        ...
        FROM token_usage_logs
        WHERE ${whereSql}
        GROUP BY client, native_currency
      ...
      const endpointStmt = db.prepare(`
        ...
        FROM token_usage_logs
        WHERE ${whereSql}
        GROUP BY endpoint_id, native_currency
        ORDER BY total_tokens DESC
      `);
      ...
      const modelStmt = db.prepare(`
        ...
        FROM token_usage_logs
        WHERE ${whereSql}
        GROUP BY model, purpose, native_currency
        ORDER BY total_tokens DESC
      `);
      ...
      const detailStmt = db.prepare(`
        ...
        FROM token_usage_logs
        WHERE ${whereSql}
        GROUP BY client, endpoint_id, model, native_currency
        ORDER BY total_tokens DESC
      `);
