...
// Register built-in providers here. Future Codex auth can register without changing HTTP/CLI callers.
import {
...
export function ensureSubscriptionAuthProviders() {
  ...
  // Future: registerSubscriptionAuthProvider(codexSubscriptionAuthProvider);
  bootstrapped = true;
}
