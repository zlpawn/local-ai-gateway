...
export const REDIRECT_PORT = 18789;
...
export const V1INTERNAL_BASE_URLS = process.env.ANTIGRAVITY_REST_BASE_URL
  ...
  : [
      // Desktop language_server.log uses daily-cloudcode-pa as the live endpoint.
...
export const OAUTH_USER_AGENT = "shrimp/0.0.3 google-oauth";