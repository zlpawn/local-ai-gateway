...
export function detectUv() {
  try {
    execSync("uv --version", { encoding: "utf8", timeout: 3000, stdio: ["pipe", "pipe", "pipe"], windowsHide: true });
    return true;
  } catch {
    return false;
  }
...
export function detectPipx() {
  try {
    execSync("pipx --version", { encoding: "utf8", timeout: 3000, stdio: ["pipe", "pipe", "pipe"], windowsHide: true });
    return true;
  } catch {
    return false;
  }
